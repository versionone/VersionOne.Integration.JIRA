...
Copyright (c) 2008-2020 [Digital.ai](http://Digital.ai/). All rights reserved.
...
The binaries for this integration can be downloaded as a ZIP file from the [VersionOne Application Catalog](http://appcatalog.digital.ai/VersionOne.Integration.JIRA) which will contain the following:
...
- [VersionOne Technical Services](http://digital.ai/training/technical_services/): A paid support offering, this team provides API training, development pairing, and complete custom development services.  
